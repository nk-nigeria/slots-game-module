...
type SlotDesk struct {
	...
	Matrices   []int32 `protobuf:"varint,1,rep,packed,name=matrices,proto3" json:"matrices,omitempty"`
	Chips      int64   `protobuf:"varint,2,opt,name=chips,proto3" json:"chips,omitempty"`
	MatrixWins []int32 `protobuf:"varint,3,rep,packed,name=matrix_wins,json=matrixWins,proto3" json:"matrix_wins,omitempty"`
}
...
func (x *SlotDesk) GetMatrices() []int32 {
	if x != nil {
		return x.Matrices
	}
	return nil
...
func (x *SlotDesk) GetChips() int64 {
	if x != nil {
		return x.Chips
	}
	return 0
...
func (x *SlotDesk) GetMatrixWins() []int32 {
	if x != nil {
		return x.MatrixWins
	}
	return nil
...
var file_slots_game_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x5d, 0x0a, 0x08, 0x53, 0x6c, 0x6f, 0x74, 0x44,
	0x65, 0x73, 0x6b, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x63, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x05, 0x52, 0x08, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x63, 0x65, 0x73, 0x12,
	0x14, 0x0a, 0x05, 0x63, 0x68, 0x69, 0x70, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05,
	0x63, 0x68, 0x69, 0x70, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x61, 0x74, 0x72, 0x69, 0x78, 0x5f,
	0x77, 0x69, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x05, 0x52, 0x0a, 0x6d, 0x61, 0x74, 0x72,
	0x69, 0x78, 0x57, 0x69, 0x6e, 0x73, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_slots_game_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_slots_game_proto_goTypes = []interface{}{
	(*SlotDesk)(nil), // 0: api.SlotDesk
}
